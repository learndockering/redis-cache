...
public class ClusterRedisCacheImpl implements ClusterRedisCache {
	...
	public boolean remove(String key) {
		...
		try {
			...
			LoggerUtil.getCacheLogger().error(e.getLocalizedMessage(), e);
			tag = false;
		}
		return tag;
	}
	...
	public boolean set(String key, Object value, Integer expiredTime) {
		...
		try {
			...
			LoggerUtil.getCacheLogger().error(e.getLocalizedMessage());
			tag = false;
		}
		return tag;
	}
	...
	public Map<String, Object> getClusterNodes() {
		Map<String, Object> clusterNodes = new HashMap<String, Object>();
